...
// trap code below
#define TRAP_CODE_NONE 0x00000000
...
// F-extensions
#define FEXT_ACCURUED_EXCEPTION_NV 0x00000010
#define FEXT_ACCURUED_EXCEPTION_DZ 0x00000008
#define FEXT_ACCURUED_EXCEPTION_OF 0x00000004
#define FEXT_ACCURUED_EXCEPTION_UF 0x00000002
#define FEXT_ACCURUED_EXCEPTION_NX 0x00000001
#define FEXT_ROUNDING_MODE_RNE 0x0
#define FEXT_ROUNDING_MODE_RTZ 0x1
#define FEXT_ROUNDING_MODE_RDN 0x2
#define FEXT_ROUNDING_MODE_RUP 0x3
#define FEXT_ROUNDING_MODE_RMM 0x4
#define FEXT_ROUNDING_MODE_DYN 0x7
...
// physical memory protection codes
...
#define CSR_EXTENSION_STATUS_OFF 0x0
#define CSR_EXTENSION_STATUS_INITIAL 0x1
#define CSR_EXTENSION_STATUS_CLEAN 0x2
#define CSR_EXTENSION_STATUS_DIRTY 0x3

// csr addr
/// f-ext
#define CSR_ADDR_U_FFLAGS 0x00000001
#define CSR_ADDR_U_FRM 0x00000002
#define CSR_ADDR_U_FCSR 0x00000003
...
#define CSR_ADDR_M_PMPADDR1 0x000003b1
#define CSR_ADDR_M_PMPADDR2 0x000003b2
#define CSR_ADDR_M_PMPADDR3 0x000003b3
#define CSR_ADDR_M_PMPADDR4 0x000003b4
#define CSR_ADDR_M_PMPADDR5 0x000003b5
#define CSR_ADDR_M_PMPADDR6 0x000003b6
#define CSR_ADDR_M_PMPADDR7 0x000003b7
#define CSR_ADDR_M_PMPADDR8 0x000003b8
#define CSR_ADDR_M_PMPADDR9 0x000003b9
#define CSR_ADDR_M_PMPADDR10 0x000003ba
#define CSR_ADDR_M_PMPADDR11 0x000003bb
#define CSR_ADDR_M_PMPADDR12 0x000003bc
#define CSR_ADDR_M_PMPADDR13 0x000003bd
#define CSR_ADDR_M_PMPADDR14 0x000003be
#define CSR_ADDR_M_PMPADDR15 0x000003bf
#define CSR_ADDR_M_PMPADDR16 0x000003c0
#define CSR_ADDR_M_PMPADDR17 0x000003c1
#define CSR_ADDR_M_PMPADDR18 0x000003c2
#define CSR_ADDR_M_PMPADDR19 0x000003c3
#define CSR_ADDR_M_PMPADDR20 0x000003c4
#define CSR_ADDR_M_PMPADDR21 0x000003c5
#define CSR_ADDR_M_PMPADDR22 0x000003c6
#define CSR_ADDR_M_PMPADDR23 0x000003c7
#define CSR_ADDR_M_PMPADDR24 0x000003c8
#define CSR_ADDR_M_PMPADDR25 0x000003c9
#define CSR_ADDR_M_PMPADDR26 0x000003ca
#define CSR_ADDR_M_PMPADDR27 0x000003cb
#define CSR_ADDR_M_PMPADDR28 0x000003cc
#define CSR_ADDR_M_PMPADDR29 0x000003cd
#define CSR_ADDR_M_PMPADDR30 0x000003ce
#define CSR_ADDR_M_PMPADDR31 0x000003cf
#define CSR_ADDR_M_PMPADDR32 0x000003d0
#define CSR_ADDR_M_PMPADDR33 0x000003d1
#define CSR_ADDR_M_PMPADDR34 0x000003d2
#define CSR_ADDR_M_PMPADDR35 0x000003d3
#define CSR_ADDR_M_PMPADDR36 0x000003d4
#define CSR_ADDR_M_PMPADDR37 0x000003d5
#define CSR_ADDR_M_PMPADDR38 0x000003d6
#define CSR_ADDR_M_PMPADDR39 0x000003d7
#define CSR_ADDR_M_PMPADDR40 0x000003d8
#define CSR_ADDR_M_PMPADDR41 0x000003d9
#define CSR_ADDR_M_PMPADDR42 0x000003da
#define CSR_ADDR_M_PMPADDR43 0x000003db
#define CSR_ADDR_M_PMPADDR44 0x000003dc
#define CSR_ADDR_M_PMPADDR45 0x000003dd
#define CSR_ADDR_M_PMPADDR46 0x000003de
#define CSR_ADDR_M_PMPADDR47 0x000003df
#define CSR_ADDR_M_PMPADDR48 0x000003e0
#define CSR_ADDR_M_PMPADDR49 0x000003e1
#define CSR_ADDR_M_PMPADDR50 0x000003e2
#define CSR_ADDR_M_PMPADDR51 0x000003e3
#define CSR_ADDR_M_PMPADDR52 0x000003e4
#define CSR_ADDR_M_PMPADDR53 0x000003e5
#define CSR_ADDR_M_PMPADDR54 0x000003e6
#define CSR_ADDR_M_PMPADDR55 0x000003e7
#define CSR_ADDR_M_PMPADDR56 0x000003e8
#define CSR_ADDR_M_PMPADDR57 0x000003e9
#define CSR_ADDR_M_PMPADDR58 0x000003ea
#define CSR_ADDR_M_PMPADDR59 0x000003eb
#define CSR_ADDR_M_PMPADDR60 0x000003ec
#define CSR_ADDR_M_PMPADDR61 0x000003ed
#define CSR_ADDR_M_PMPADDR62 0x000003ee
#define CSR_ADDR_M_PMPADDR63 0x000003ef
#define CSR_ADDR_M_PMPCFG0 0x000003a0
#define CSR_ADDR_M_PMPCFG1 0x000003a1
#define CSR_ADDR_M_PMPCFG2 0x000003a2
#define CSR_ADDR_M_PMPCFG3 0x000003a3
#define CSR_ADDR_M_PMPCFG4 0x000003a4
#define CSR_ADDR_M_PMPCFG5 0x000003a5
#define CSR_ADDR_M_PMPCFG6 0x000003a6
#define CSR_ADDR_M_PMPCFG7 0x000003a7
#define CSR_ADDR_M_PMPCFG8 0x000003a8
#define CSR_ADDR_M_PMPCFG9 0x000003a9
#define CSR_ADDR_M_PMPCFG10 0x000003aa
#define CSR_ADDR_M_PMPCFG11 0x000003ab
#define CSR_ADDR_M_PMPCFG12 0x000003ac
#define CSR_ADDR_M_PMPCFG13 0x000003ad
#define CSR_ADDR_M_PMPCFG14 0x000003ae
#define CSR_ADDR_M_PMPCFG15 0x000003af
...
#define OPCODE_STORE_FP 0x00000027
...
unsigned riscv_fdiv_fsqrt(unsigned src1, unsigned src2, unsigned char rm, unsigned char is_fsqrt, unsigned char *exception);
